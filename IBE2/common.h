...
// #define PARAM_Q 5 // modulus q
// #define PARAM_K 3 // size of q
...
// #define PARAM_Q 16777601 // modulus q
// #define PARAM_K 25 // size of q
// #define PARAM_N 2048 // degree of polynomials
// #define PARAM_D 1
// #define PARAM_R 64 // number of irreducible factors of x^n + 1 in F_q[x]
// #define PARAM_SIGMA 7.00 // Gaussian parameter (generation of the trapdoor)
// #define PARAM_ALPHA (15.65) // Gaussian parameter (sampling perturbations)
...
// #define PARAM_Q 1024454657 // modulus q
// #define PARAM_K 30 // size of q
// #define PARAM_N 512 // degree of polynomials
// #define PARAM_R 512 // number of irreducible factors of x^n + 1 in F_q[x]
// #define PARAM_D 1 // rank of the module
// #define PARAM_SIGMA 6.15 // Gaussian parameter (generation of the trapdoor)
// #define PARAM_ALPHA (60.50) // Gaussian parameter (sampling perturbations)
// #define PARAM_ZETA (112522.0) // Gaussian parameter (presampling)
...
#define PARAM_M (PARAM_K - PARAM_L) // parameter m ( = d(k+2) for the computational instantiation)
#define PARAM_Mprime (PARAM_K - PARAM_L)
...
// #if (PARAM_Mprime - PARAM_K <= 0)
// 	#error "PARAM_Mprime - PARAM_K must be a strictly positive value"
// #endif
